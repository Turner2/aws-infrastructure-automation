...
class InfrastructureCleaner:
    ...
    def _delete_load_balancer(self):
        ...
        print_section("1️⃣  Deleting Load Balancer")
        ...
        try:
            ...
            if not response["LoadBalancers"]:
                print("ℹ️  Load balancer not found, skipping...")
                return
    ...
    def _delete_target_group(self):
        """Delete Target Group."""
        print_section("2️⃣  Deleting Target Group")
        ...
        try:
            ...
            if e.response['Error']['Code'] == 'TargetGroupNotFound':
                ...
                print("⚠️  Target group might still be in use. Try again in a few minutes.")
    
    def _terminate_instance(self):
        """Terminate EC2 Instance."""
        print_section("3️⃣  Terminating EC2 Instance")
        ...
        try:
            ...
            if not response["Reservations"]:
                print("ℹ️  Instance not found, skipping...")
                return
    ...
    def _delete_security_groups(self):
        ...
        print_section("4️⃣  Deleting Security Groups")
        ...
        for sg_name in [self.resource_names["security_group"], self.resource_names["alb_sg"]]:
            try:
                ...
                if not response["SecurityGroups"]:
                    print(f"ℹ️  Security group '{sg_name}' not found, skipping...")
                    continue
    ...
    def _delete_key_pair(self):
        """Delete Key Pair."""
        print_section("5️⃣  Deleting Key Pair")
        ...
        try:
            ...
            print(f"⚠️  Remember to manually delete the .pem file: {self.resource_names['key_pair']}.pem")
            
        except ClientError as e:
            if e.response['Error']['Code'] == 'InvalidKeyPair.NotFound':
                print("ℹ️  Key pair not found, skipping...")
            else:
